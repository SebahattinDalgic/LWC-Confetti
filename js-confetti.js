            ...
            i(e, [
                {
                    ...
                    value: function (t) {
                        ...
                        n
                            ? (t.fillStyle = n,
                                t.beginPath(),
                                t.ellipse(e.x * h, e.y * h, Math.max(0, i.x * h), Math.max(0, i.y * h), o, 0, 2 * Math.PI),
                                t.fill())
                            : s &&
                ...
                },
                {
                    ...
                    value: function (t, e) {
                        ...
                        this.rotationSpeed -= this.emoji ? 0.0001 : 0.00001 * t;
        ...
        return (
            i(e, [
                ...
                },
                {
                    key: "addConfetti",
                    value: function () {
                        for (var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = u(t), i = e.confettiRadius, n = e.confettiNumber, s = e.confettiColors, o = e.emojis, a = e.emojiSize, r = this.canvas.getBoundingClientRect(), c = r.width, d = r.height, f = (5 * d) / 7, m = { x: 0, y: f }, v = { x: c, y: f }, p = new l(this.canvasContext), y = 0; y < n / 2; y++) {
                            var g = new h({
                                initialPosition: m,
                                direction: "right",
                                confettiRadius: i,
